 ...
 * @author franc
 */
@WebServlet(name = "ServletBorrarChat", urlPatterns = {"/ServletBorrarChat"})
public class ServletBorrarChat extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Chat elChat = this.chatFacade.find(idChat);
        this.chatFacade.remove(elChat);
